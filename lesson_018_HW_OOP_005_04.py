...
print(f'Проверка на тип класса: {isinstance(Contact, type)}')
print(f"Проверка на наследование класса: {issubclass(Contact, Update_Contact)}")
print(f"Проверка на наследование класса: {issubclass(Update_Contact, Contact)}")
